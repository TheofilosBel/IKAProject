        ...
        <main>
            ...
            <div class="container">
                ...
                <div class="panel">
                    ...
                    Μεταβείτε στην υπηρεσία <a href="#"><b>Ηλεκτρονική Υποβολή Αίτησης Συνταξιοδότησης</b></a>.<br><br>

                    Μεταβείτε στην υπηρεσία <a href="#"><b>Ηλεκτρονική Παρακολούθηση της Πορείας της Αίτησης
                    Συνταξιοδότησης</b></a>.
                    </p>
                </div>
                ...
                <div class="panel">
                    <p> Μεταβείτε στο <a href="#"><b>Εργαλείο Υπολογισμού Βασικού Ποσού Σύνταξης</b></a>.
                    </p>
                </div>
                ...
                <div class="panel">
                    ...
                    Μεταβείτε στο <a href="#"><b>Πρόγραμμα Κατ' Οίκον Φροντίδας</b></a>.
                    </p>
                </div>
                ...
                <div class="panel">
                    ...
                    Μεταβείτε στην υπηρεσία <a href="#"><b>Βεβαίωση Συντάξεων Για Φορολογική Χρήση</b></a>.
                    </p>
                </div>
                ...
                <div class="panel">
                    ...
                    Μεταβείτε στην υπηρεσία <a href="#"><b>Πληροφόρηση Συνταξιούχων για ΑΜΚΑ-ΑΦΜ</b></a>.
                    </p>
                </div>
